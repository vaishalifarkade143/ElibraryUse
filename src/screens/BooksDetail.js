...
{route.params.data.items[0].format !== 3 ?( <Text style={{textAlign:'center',fontSize:17,fontWeight:700,color: '#c27b7f'}}>Available  <Text style={{width:7,height:7,backgroundColor:'black',color:'white'}}>1</Text></Text>):(null)}
  {userToken !== null ?
          (<TouchableOpacity
            style={{
              backgroundColor: '#c27b7f',
