...
//   //   // const item=route.params.data;
//   //   if (userToken) {
//   //     // Send a GET request to your API to subscribe to the book

//   //     const ebookId = route.params.data.id; // Replace with the actual way to get the ebook_id
//   //     const libraryId = route.params.data.library_id; // Replace with the actual way to get the library_id
//   //     const email = 'info@educron.com'; // Replace with the actual user's email
//   //     try {
//   //       const response = await fetch(`https://dindayalupadhyay.smartcitylibrary.com/api/v1/ebook-subscription?ebook_id=${ebookId}&library_id=${libraryId}&email=${email}`, {
//   //         method: 'GET',
//   //         headers: {
//   //           // 'Content-Type': 'application/json',
//   //           'Authorization': `Bearer ${userToken}`,
...
//   //       if (response.ok) {
//   //         // Subscription successful, you can handle the response here
//   //         // For example, you can show a success message to the user.
//   //         console.log('Subscription successful');
//   //         navigation.navigate(('myEBook',{data:item}));
//   //       }
//   //        else {
//   //         // Handle subscription failure here, e.g., show an error message.
...
//             onPress={() => {
//               navigation.navigate('myEBook',{data:route.params.data})
//               // handleSubscribe(route.params.data);
//             }}
//           >
//             {route.params.data.items[0].format === 3 ?
