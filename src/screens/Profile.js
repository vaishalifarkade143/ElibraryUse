...
//     const [initialProfile, setInitialProfile] = useState({}); // Initial state for comparison
//     useEffect(() => {
...
//     useEffect(() => {
//         // Update the initial state when the data is loaded
//         setInitialProfile({
//             first_name,
//             last_name,
//             email,
...
//             zip,
//         });
//     }, [first_name, last_name, email, phone, address1, address2, state, city, zip]);
...
//     // Enable the "Save" button when data is dirty
//     // const isDataDirty = JSON.stringify(initialProfile) !== JSON.stringify({
//     //     first_name,
//     //     last_name,
//     //     email,
//     //     phone,
